...
scatter_observe = function(session,input_info1,input_info2,geneID,study_type){
    if(is.null(geneID)){
...
scatter_plot <- function(input,output,session,data,group_data,input_group,input_gene1,input_gene2,study_type){
