...
enrich_res_tb = function(input,output,session,deg_data,study_type){
 tryCatch({
...
#################################### pheatmap ##############################################################
kegg_heatServer<-function(input,output,session,enrich_data,omics_data,kegg_path,group_info,phenotype_data,study_type,group_info_deg){
