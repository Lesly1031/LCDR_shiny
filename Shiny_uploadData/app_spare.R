...
source("F:/Projects/Brooke/lung_repo/Shiny/Shiny_Github/Shiny_uploadData/heatmap_plot.R")
...
source("F:/Projects/Brooke/lung_repo/Shiny/Shiny_Github/Shiny_uploadData/immune_deconv_table.R")
source("F:/Projects/Brooke/lung_repo/Shiny/Shiny_Github/Shiny_uploadData/heat_immuneDeconv.R")
source("F:/Projects/Brooke/lung_repo/Shiny/Shiny_Github/Shiny_uploadData/box_immuneDeconv.R")

source("F:/Projects/Brooke/lung_repo/Shiny/Shiny_Github/Shiny_uploadData/scatter_plot_across.R")
source("F:/Projects/Brooke/lung_repo/Shiny/Shiny_Github/Shiny_uploadData/heat_kegg_any.R")
...
server <- function(input, output,session) { 
  ...
  study_type<- reactive({
    # query = parseQueryString(session$clientData$url_search)
    # c("RNAseq_v1","RNAseq_v2")
    #"RNAseq_v2"
    #c("lipidomics_serum")
    # c("proteomics","lipidomics_serum")
    "RNAseq"
    #"metabolomics"
    # c("metabolomics","metabolomics")
    # c("RNAseq","metabolomics")
  })
  # study_type <- reactive({
  #   lapply(1:length(study_id()),function(x){
  #     
  #     file =  paste0("F:/Projects/Brooke/lung_repo/Shiny/Shiny_Github/Shiny_uploadData/studies/",study_id()[x])
  #     study_type = list.files(file)
  #     study_type
  #   })
  # })
